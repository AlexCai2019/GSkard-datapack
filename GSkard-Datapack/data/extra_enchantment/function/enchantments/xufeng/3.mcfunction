...
execute store result entity @s Motion[0] double 0.005 run scoreboard players operation @s temp_Mob_Move1_ -= @s temp_Mob_Move1
execute store result entity @s Motion[1] double 0.005 run scoreboard players operation @s temp_Mob_Move2_ -= @s temp_Mob_Move2
execute store result entity @s Motion[2] double 0.005 run scoreboard players operation @s temp_Mob_Move3_ -= @s temp_Mob_Move3