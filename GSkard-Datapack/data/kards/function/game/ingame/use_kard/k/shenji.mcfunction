execute if score #system GameStatus matches 1 if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'飞雷神'}] if score @s kardCount >= #kard_feileishen kardCount run function kards:game/yongpaiku/shenji/feileishen/1
execute if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'好高骛远'}] if score @s kardCount >= #kard_haogaowuyuan kardCount run function kards:game/yongpaiku/shenji/haogaowuyuan
execute if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'火力全开'}] if score @s kardCount >= #kard_huoliquankai kardCount run function kards:game/yongpaiku/shenji/huoliquankai
execute if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'墓园狂欢'}] if score @s kardCount >= #kard_muyuankuanghuan kardCount run function kards:game/yongpaiku/shenji/muyuankuanghuan
execute if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'胜利号角'}] if score @s kardCount >= #kard_shenglihaojiao kardCount run function kards:game/yongpaiku/shenji/shenglihaojiao
execute if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'虚空回响'}] if score @s kardCount >= #kard_xukonghuixiang kardCount run function kards:game/yongpaiku/shenji/xukonghuixiang
