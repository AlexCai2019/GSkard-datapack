...
#检测pvp
execute if score 回合数 GameRound >= #system RoundCount unless score #system infinite_round matches 1 run return run function kards:game/ingame/round/pvpround/waitstart
#回合轮换
