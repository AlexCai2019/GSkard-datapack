execute store result bossbar minecraft:pvp_start_countdown value run scoreboard players remove #pvp pvp_start_countdown 1
...
execute if score #pvp pvp_start_countdown matches 1.. run schedule function kards:game/ingame/round/pvpround/countdown 1t