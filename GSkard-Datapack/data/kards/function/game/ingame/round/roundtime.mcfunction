execute store result bossbar minecraft:roundtime value unless entity @a[tag=talent_dialog_show,gamemode=adventure] run scoreboard players remove time roundtime 1
