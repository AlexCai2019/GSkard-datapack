...
execute as @s[scores={HealBack=-1}] run return run function kards:game/ingame/custom_buff/healback/bossbar/remove with storage temp
execute as @s[type=player] run function kards:game/ingame/custom_buff/healback/bossbar/2 with storage temp
