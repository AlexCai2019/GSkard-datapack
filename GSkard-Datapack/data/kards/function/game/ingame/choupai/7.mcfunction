$execute store result score @s random7 run random value 1..$(zuzhou)
...
execute if score @s random7 matches 14 run function kards:game/paiku/zuzhou/beipan

execute if score @s random7 matches 15.. run function kards-dlc:kard/type/zuzhou/ganeral
