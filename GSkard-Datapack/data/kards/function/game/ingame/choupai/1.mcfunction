...
execute if score @s random1 matches 21 run function kards:game/paiku/jiben/nishi
execute if score @s random1 matches 22 run function kards:game/paiku/jiben/ehun
execute if score @s random1 matches 23 run function kards:game/paiku/jiben/xiaohuanyi
...
execute if score @s random1 matches 27 run function kards:game/paiku/jiben/beijixiong
execute if score @s random1 matches 28 run function kards:game/paiku/jiben/jiaohai
execute if score @s random1 matches 29 run function kards:game/paiku/jiben/xuanfengqishi

execute if score @s random1 matches 30.. run function kards-dlc:kard/type/jiben/general
