...
execute if score @s random matches 1..35 run tellraw @s ["",{color:"aqua",text:"[变废为宝]"},{color:"red",text:"销毁1张"},{color:"dark_gray",text:"[诅咒牌] "},{color:"gold",text:"成功抽取了1张"},{color:"dark_gray",text:"[诅咒牌] "}]
execute if score @s random matches 36..40 run tellraw @s ["",{color:"aqua",text:"[变废为宝]"},{color:"red",text:"销毁1张"},{color:"dark_gray",text:"[诅咒牌] "},{color:"gold",text:"成功抽取了1张"},{color:"dark_gray",text:"[诅咒牌] "}]
