scoreboard players set @s Talent_bianfeiweibao_drop_shenji 0
...
kill @n[type=item,nbt={Item:{id:"minecraft:music_disc_strad"}}]
execute store result score @s random run random value 1..100
execute if score @s random matches 1..35 run scoreboard players add @s shenjicishu 1
execute if score @s random matches 36..40 run scoreboard players add @s shenjicishu 2

execute if score @s random matches 1..35 run tellraw @s ["",{color:"aqua",text:"[变废为宝]"},{color:"red",text:"销毁1张"},{color:"white",text:"[神迹牌]"},{color:"white",text:" "},{color:"gold",text:"成功抽取了1张"},{color:"white",text:"[神迹牌]"}]
execute if score @s random matches 36..40 run tellraw @s ["",{color:"aqua",text:"[变废为宝]"},{color:"red",text:"销毁1张"},{color:"white",text:"[神迹牌]"},{color:"white",text:" "},{color:"gold",text:"成功抽取了2张"},{color:"white",text:"[神迹牌]"}]
