...
# Equipment
item replace entity @s armor.chest with minecraft:netherite_chestplate[minecraft:custom_name={italic:false,text: "下界合金胸甲",color:"dark_gray"},minecraft:unbreakable={},tooltip_display={hidden_components:["unbreakable"]},lore=[{text: "套装效果：",color:"gray",italic:false},[{text: "穿戴2件时 获得",color:"gray",italic:false},{text: "抗性提升1",color:"gold",italic:false}],[{text: "穿戴3件时 获得",color:"gray",italic:false},{text: "抗性提升2",color:"gold",italic:false}],[{text: "穿戴4件时 获得",color:"gray",italic:false},{text: "抗性提升3",color:"gold",italic:false}]],custom_data={kards:'守护者'},enchantments={binding_curse:1}]
