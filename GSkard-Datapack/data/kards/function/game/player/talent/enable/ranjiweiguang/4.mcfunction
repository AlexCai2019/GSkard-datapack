...
execute if score @s MoveTime matches 4 run particle end_rod ~ ~ ~ 0.2 0.2 0.2 0 25
execute if score @s MoveTime matches 4 run scoreboard players reset @s MoveTime
...
execute if score @s Talent_ranjiweiguang_Ball_DeathTime matches 0 as @a[tag=Talent_ranjiweiguang,gamemode=spectator] if score @s lifetime = @n[tag=Talent_ranjiweiguang_Ball_Damage,type=marker] lifetime run tag @s add Talent_ranjiweiguang_Ball_Damage
