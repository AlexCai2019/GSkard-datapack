...
tag @s add Talent_qiongbingduwu
...
# Tellraw
execute as @s[team=red] run tellraw @a[team=red,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"穷兵黩武",color:"aqua",hover_event:{action:"show_text",value:["",{"color":"gray","text":"在本局游戏内 友方回合结束时\n造成"},{"color":"gold","text":"5♥破甲伤害"},{"color":"gray","text":"分配至所有敌方玩家\n友方回合内每次"},{"color":"gold","text":"使用卡牌"},{"color":"gray","text":"都有"},{"color":"dark_aqua","text":"30%概率"},{"color":"gray","text":"使"},{"color":"gold","text":"伤害提升0.5♥"}]}}]
execute as @s[team=blue] run tellraw @a[team=blue,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"穷兵黩武",color:"aqua",hover_event:{action:"show_text",value:["",{"color":"gray","text":"在本局游戏内 友方回合结束时\n造成"},{"color":"gold","text":"5♥破甲伤害"},{"color":"gray","text":"分配至所有敌方玩家\n友方回合内每次"},{"color":"gold","text":"使用卡牌"},{"color":"gray","text":"都有"},{"color":"dark_aqua","text":"30%概率"},{"color":"gray","text":"使"},{"color":"gold","text":"伤害提升0.5♥"}]}}]