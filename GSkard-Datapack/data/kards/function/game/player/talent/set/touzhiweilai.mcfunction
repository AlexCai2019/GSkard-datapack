...
# Tellraw
execute as @s[team=red] run tellraw @a[team=red,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"透支未来",color:"aqua",hover_event:{action:"show_text",value:[{text:"获得30Kmax 抽5张牌 +150级经验值\n",color:"gold"},{text:"在本局游戏内",color:"gray"},{text:"你的Kmax不再在友方回合开始时增加",color:"red"}]}}]
execute as @s[team=blue] run tellraw @a[team=blue,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"透支未来",color:"aqua",hover_event:{action:"show_text",value:[{text:"获得30Kmax 抽5张牌 +150级经验值\n",color:"gold"},{text:"在本局游戏内",color:"gray"},{text:"你的Kmax不再在友方回合开始时增加",color:"red"}]}}]