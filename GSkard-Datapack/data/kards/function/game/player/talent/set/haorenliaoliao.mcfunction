...
tag @s add Talent_haorenliaoliao
...
# Tellraw
execute as @s[team=red] run tellraw @a[team=red,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"好人寥寥",color:"aqua",hover_event:{action:"show_text",value:[{text:"在本局游戏内\n",color:"gray"},{text:"你每次使用非",color:"gold"},{text:"[衍生牌]",color:"aqua"},{text:"时\n",color:"gold"},{text:"有18%的概率抽取1张同种类的卡牌\n",color:"gold"}]}}]
execute as @s[team=blue] run tellraw @a[team=blue,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"好人寥寥",color:"aqua",hover_event:{action:"show_text",value:[{text:"在本局游戏内\n",color:"gray"},{text:"你每次使用非",color:"gold"},{text:"[衍生牌]",color:"aqua"},{text:"时\n",color:"gold"},{text:"有18%的概率抽取1张同种类的卡牌\n",color:"gold"}]}}]