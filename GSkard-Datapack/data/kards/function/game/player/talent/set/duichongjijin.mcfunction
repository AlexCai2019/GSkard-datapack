...
scoreboard players add @s kardCountmax 8
...
# Tellraw
execute as @s[team=red] run tellraw @a[team=red,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"对冲基金",color:"gold",hover_event:{action:"show_text",value:[{text:"立刻获得",color:"gray"},{text:"8Kmax\n",color:"gold"},{text:"友方回合开始时\n",color:"gray"},{text:"你每有9Kmax额外获得1Kmax",color:"gold"}]}}]
execute as @s[team=blue] run tellraw @a[team=blue,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"对冲基金",color:"gold",hover_event:{action:"show_text",value:[{text:"立刻获得",color:"gray"},{text:"8Kmax\n",color:"gold"},{text:"友方回合开始时\n",color:"gray"},{text:"你每有9Kmax额外获得1Kmax",color:"gold"}]}}]