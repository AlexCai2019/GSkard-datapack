...
# Tellraw
execute as @s[team=red] run tellraw @a[team=red,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"禁忌之始",color:"dark_purple",hover_event:{action:"show_text",value:[{"color":"gray","text":"立刻获得1张"},{"color":"dark_purple","text":"[禁字启封]"},"\n",{"color":"gray","text":"4回合后再获得1张"},{"color":"dark_purple","text":"[禁字启封]"},"\n",{"color":"gray","text":"8回合后再获得1张"},{"color":"dark_purple","text":"[禁字启封]"}]}}]
execute as @s[team=blue] run tellraw @a[team=blue,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"禁忌之始",color:"dark_purple",hover_event:{action:"show_text",value:[{"color":"gray","text":"立刻获得1张"},{"color":"dark_purple","text":"[禁字启封]"},"\n",{"color":"gray","text":"4回合后再获得1张"},{"color":"dark_purple","text":"[禁字启封]"},"\n",{"color":"gray","text":"8回合后再获得1张"},{"color":"dark_purple","text":"[禁字启封]"}]}}]