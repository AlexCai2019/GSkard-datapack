...
# Tellraw
execute as @s[team=red] run tellraw @a[team=red,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"机械感染",color:"gray",hover_event:{action:"show_text",value:["",{"color":"gray","text":"你"},{"color":"gold","text":"每击杀5个生物"},"\n",{"color":"gold","text":"位于自己"},{"color":"gray","text":"召唤1只"},{"color":"red","text":"生命值减少伤害减少"},{"color":"gray","text":"的"},{"color":"gold","text":"铁傀儡"}]}}]
execute as @s[team=blue] run tellraw @a[team=blue,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"机械感染",color:"gray",hover_event:{action:"show_text",value:["",{"color":"gray","text":"你"},{"color":"gold","text":"每击杀5个生物"},"\n",{"color":"gold","text":"位于自己"},{"color":"gray","text":"召唤1只"},{"color":"red","text":"生命值减少伤害减少"},{"color":"gray","text":"的"},{"color":"gold","text":"铁傀儡"}]}}]