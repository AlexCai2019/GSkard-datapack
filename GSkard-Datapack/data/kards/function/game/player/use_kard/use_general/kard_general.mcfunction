execute unless score @s pingbi matches 1 run function kards:game/player/use_kard/use_general/info/tellraw
...
execute if items entity @s weapon.offhand music_disc_blocks run function kards:game/player/use_kard/use_general/type/tuteng
execute if items entity @s weapon.offhand music_disc_wait run function kards:game/player/use_kard/use_general/type/xianjing
execute if items entity @s weapon.offhand music_disc_mellohi run function kards:game/player/use_kard/use_general/type/fashu
execute if items entity @s weapon.offhand music_disc_stal run function kards:game/player/use_kard/use_general/type/zuzhou
execute if items entity @s weapon.offhand music_disc_strad run function kards:game/player/use_kard/use_general/type/shenji
