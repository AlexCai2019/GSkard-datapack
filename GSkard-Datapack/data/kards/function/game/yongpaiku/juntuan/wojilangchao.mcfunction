...
execute if entity @s[team=red] if score 蓝队 manshui matches 1 as @e[tag=Mob_Start] run item replace entity @s weapon.mainhand with trident[enchantments={"kards:zhengyichangji/leiji":1}]
execute if entity @s[team=red] if score 蓝队 manshui matches 1 run scoreboard players remove @s kardCount 8
execute if entity @s[team=blue] if score 红队 manshui matches 1 as @e[tag=Mob_Start] run item replace entity @s weapon.mainhand with trident[enchantments={"kards:zhengyichangji/leiji":1}]
