...
execute if entity @s[team=blue] if entity @s[team=blue] if score 红队 xianjing_shufashixiao matches 0 unless entity @e[tag=tuteng,team=red] run tellraw @a [{text: "[红队]滚木",color:"red"},{text: "被劫走了！",color:"gold"}]
