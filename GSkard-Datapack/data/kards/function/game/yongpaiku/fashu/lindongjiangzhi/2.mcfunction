...
execute if score 红队 fashu_lindongjiangzhi matches 1.. if score #system dituxuanze matches 101.. at @e[tag=red_marker_7] as @a[team=red,distance=..18] run function kards:game/yongpaiku/fashu/lindongjiangzhi/3
execute if score 蓝队 fashu_lindongjiangzhi matches 1.. if score #system dituxuanze matches 101.. at @e[tag=blue_marker_7] as @a[team=blue,distance=..18] run function kards:game/yongpaiku/fashu/lindongjiangzhi/3
