...
execute store result entity @s Motion[0] double 0.0001 run scoreboard players operation @s temp_Mob_Move1_ -= @s temp_Mob_Move1
execute store result entity @s Motion[1] double 0.0001 run scoreboard players operation @s temp_Mob_Move2_ -= @s temp_Mob_Move2
execute store result entity @s Motion[2] double 0.0001 run scoreboard players operation @s temp_Mob_Move3_ -= @s temp_Mob_Move3

scoreboard players set @s Mob_Skill_Time 0