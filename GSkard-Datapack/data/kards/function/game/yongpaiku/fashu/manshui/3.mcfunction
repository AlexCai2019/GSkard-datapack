execute as @s[team=red] if score 蓝队 diyu matches 1.. run scoreboard players set 蓝队 diyu 0
execute as @s[team=blue] if score 红队 diyu matches 1.. run scoreboard players set 红队 diyu 0
