execute unless items entity @s container.* #kards:kard run return run tellraw @a [{selector:"@s"},{text: "的滚木被",color:"aqua"},{selector:"@a[tag=User,limit=1]"},{text: "弃掉了!",color:"aqua"}]
execute store result score @s random_clear run random value 0..35

execute if score @s random_clear matches 0 unless items entity @s container.0 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 1 unless items entity @s container.1 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 2 unless items entity @s container.2 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 3 unless items entity @s container.3 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 4 unless items entity @s container.4 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 5 unless items entity @s container.5 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 6 unless items entity @s container.6 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 7 unless items entity @s container.7 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 8 unless items entity @s container.8 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 9 unless items entity @s container.9 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 10 unless items entity @s container.10 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 11 unless items entity @s container.11 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 12 unless items entity @s container.12 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 13 unless items entity @s container.13 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 14 unless items entity @s container.14 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 15 unless items entity @s container.15 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 16 unless items entity @s container.16 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 17 unless items entity @s container.17 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 18 unless items entity @s container.18 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 19 unless items entity @s container.19 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 20 unless items entity @s container.20 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 21 unless items entity @s container.21 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 22 unless items entity @s container.22 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 23 unless items entity @s container.23 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 24 unless items entity @s container.24 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 25 unless items entity @s container.25 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 26 unless items entity @s container.26 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 27 unless items entity @s container.27 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 28 unless items entity @s container.28 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 29 unless items entity @s container.29 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 30 unless items entity @s container.30 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 31 unless items entity @s container.31 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 32 unless items entity @s container.32 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 33 unless items entity @s container.33 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 34 unless items entity @s container.34 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
execute if score @s random_clear matches 35 unless items entity @s container.35 #kards:kard run return run function kards:game/yongpaiku/fashu/guohechaiqiao/2
