...
execute if entity @s[team=red] if score 红队 tanyu_temp_2 matches 9 as @a at @s run playsound kards:dogdoing player @s ~ ~ ~ 100 1
execute if entity @s[team=blue] if score 蓝队 tanyu_temp_2 matches 9 as @a at @s run playsound kards:dogdoing player @s ~ ~ ~ 100 1
