    execute as @s[team=red] at @e[tag=blue_marker_7,limit=1] run summon polar_bear ~ 0 ~ {Team:red,Tags:["Mob_Start"],attributes:[{id:"follow_range",base:100}]}
    execute as @s[team=blue] at @e[tag=red_marker_7,limit=1] run summon polar_bear ~ 0 ~ {Team:blue,Tags:["Mob_Start"],attributes:[{id:"follow_range",base:100}]}
