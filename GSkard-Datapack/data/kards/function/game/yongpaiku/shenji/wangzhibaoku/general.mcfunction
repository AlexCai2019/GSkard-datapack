...
#森林之护
execute as @a if items entity @s armor.chest leather_chestplate[custom_data~{kards:'森林之护'}] run tag @s add senlinzhihu
...
execute as @a[tag=senlinzhihu] unless items entity @s armor.chest leather_chestplate[custom_data~{kards:'森林之护'}] run tag @s remove senlinzhihu
#天神石板甲
execute as @a if items entity @s armor.chest golden_chestplate[custom_data~{kards:'天神石板甲'}] run tag @s add tianshenshibanjia
execute as @a if items entity @s armor.chest golden_chestplate[custom_data~{kards:'天神石板甲'}] run tag @s add tianshenshibanjia_Bossbar

execute as @a[tag=tianshenshibanjia] if items entity @s armor.chest golden_chestplate[custom_data~{kards:'天神石板甲',feishenghufu:"绝唱"}] unless score @s tianshenshibanjia_xiansheng matches 10.. run scoreboard players set @s tianshenshibanjia_xiansheng 10
...
#凛冬之铠
execute as @a if items entity @s armor.chest diamond_chestplate[custom_data~{kards:'凛冬之铠'}] run tag @s add lindongzhikai
...
execute as @a[tag=lindongzhikai] unless items entity @s armor.chest diamond_chestplate[custom_data~{kards:'凛冬之铠'}] run tag @s remove lindongzhikai
#苦难摇篮
execute as @a if items entity @s armor.chest chainmail_chestplate[custom_data~{kards:'苦难摇篮'}] run tag @s add kunanyaolan

execute as @a[tag=kunanyaolan] if items entity @s armor.chest chainmail_chestplate[custom_data~{kards:'苦难摇篮',feishenghufu:"绝唱"}] run function kards:game/yongpaiku/shenji/wangzhibaoku/kunanyaolan/max_health/

scoreboard players set @a kunanyaolan_hurt_juechang 0
...
execute as @a[tag=kunanyaolan] if score @s kunanyaolan_hurt_1 matches 200.. run scoreboard players operation @s kunanyaolan_damage += @s kunanyaolan_hurt_juechang_maxhealth
...
execute as @a[tag=kunanyaolan] unless items entity @s armor.chest chainmail_chestplate[custom_data~{kards:'苦难摇篮'}] run tag @s remove kunanyaolan
#祥兆玉石
execute as @a if items entity @s container.* emerald[custom_data~{kards:'祥兆玉石'}] run tag @s add xiangzhaoyushi
...
execute as @a[tag=xiangzhaoyushi] unless items entity @s container.* emerald[custom_data~{kards:'祥兆玉石'}] run tag @s remove xiangzhaoyushi
...
execute as @a[tag=fengbaozhanchui] if score @s fengbaozhanchui_xuneng matches 20 run function kards:game/yongpaiku/shenji/wangzhibaoku/fengbaozhanchui/3
...
execute as @a[tag=fengbaozhanchui_xunengzhongji] unless score @s fengbaozhanchui_xuneng_Time matches 495..500 if data entity @s {OnGround:1b} at @s run function kards:game/yongpaiku/shenji/wangzhibaoku/fengbaozhanchui/4
#死神之镰
...
execute as @a[tag=sishenzhilian] unless items entity @s weapon.mainhand netherite_hoe[custom_data~{kards:'死神之镰'}] run tag @s remove sishenzhilian

execute as @a store result score @s sishenzhilian_soul_small_ run clear @s *[minecraft:custom_data~{kards:'灵魂_小',feishenghufu:"绝唱灵魂"}] 0
execute as @a if score @s sishenzhilian_soul_small_ matches 10.. run function kards:game/yongpaiku/shenji/wangzhibaoku/sishenzhilian/fusion/juechang/1
execute as @a store result score @s sishenzhilian_soul_medium_ run clear @s *[minecraft:custom_data~{kards:'灵魂_中',feishenghufu:"绝唱灵魂"}] 0
execute as @a if score @s sishenzhilian_soul_medium_ matches 10.. run function kards:game/yongpaiku/shenji/wangzhibaoku/sishenzhilian/fusion/juechang/2
...
execute as @a if score @s sishenzhilian_soul_small matches 10.. run function kards:game/yongpaiku/shenji/wangzhibaoku/sishenzhilian/fusion/normal/1
execute as @a if score @s sishenzhilian_soul_medium matches 10.. run function kards:game/yongpaiku/shenji/wangzhibaoku/sishenzhilian/fusion/normal/2
#正义长戟
execute as @a if items entity @s weapon.mainhand trident[custom_data~{kards:'正义长戟'}] run tag @s add zhengyichangji
...
execute as @a if score @s zhengyichangji_Time matches 1 run tellraw @s [{text: "[正义长戟] ",color:"aqua"},{text: "制裁效果就绪!",color:"green"}]
execute as @a if score @s zhengyichangji_Time matches 1 at @s run playsound minecraft:item.trident.riptide_1 player @s ~ ~ ~ 100 2
execute as @a if score @s zhengyichangji_Time matches 1.. run scoreboard players remove @s zhengyichangji_Time 1
#轻灵之语
...
execute as @a[tag=yanyangdajian] if predicate kards:sneak unless score @s yanyangdajian_Time matches 1.. run scoreboard players add @s yanyangdajian 1
execute as @a[tag=yanyangdajian] unless predicate kards:sneak run scoreboard players reset @s yanyangdajian
execute as @a[tag=yanyangdajian] if score @s yanyangdajian matches 50 run function kards:game/yongpaiku/shenji/wangzhibaoku/yanyangdajian/skill
...
execute as @a[scores={yanyangdajian_fenshaozhiyu=1..}] run function kards:game/yongpaiku/shenji/wangzhibaoku/yanyangdajian/fenshaozhiyu/
scoreboard players reset @a[scores={yanyangdajian_fenshaozhiyu=0}] yanyangdajian_fenshaozhiyu_healback
scoreboard players reset @a[scores={yanyangdajian_fenshaozhiyu=0}] yanyangdajian_fenshaozhiyu
...
scoreboard players remove @a[scores={diaolingtaidao_Time=1..}] diaolingtaidao_Time 1
