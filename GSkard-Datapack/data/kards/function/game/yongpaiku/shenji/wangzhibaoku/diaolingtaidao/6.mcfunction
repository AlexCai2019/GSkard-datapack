...
execute if items entity @s weapon.* netherite_sword[custom_data~{kards:'凋零太刀'}] run scoreboard players set @s[scores={diaolingtaidao_Time=1..}] diaolingtaidao_Time 0
execute if items entity @s container.* netherite_sword[custom_data~{kards:'凋零太刀'}] run scoreboard players set @s[scores={diaolingtaidao_Time=1..}] diaolingtaidao_Time 0
