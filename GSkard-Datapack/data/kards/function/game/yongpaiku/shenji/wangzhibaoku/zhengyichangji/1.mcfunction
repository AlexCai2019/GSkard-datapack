...
execute as @s[team=red] as @e[team=red,distance=..2.5] run damage @s 3 kards:chuanci by @p[tag=zhengyichangji,team=blue]
execute as @s[team=blue] as @e[team=blue,distance=..2.5] run damage @s 3 kards:chuanci by @p[tag=zhengyichangji,team=red]
