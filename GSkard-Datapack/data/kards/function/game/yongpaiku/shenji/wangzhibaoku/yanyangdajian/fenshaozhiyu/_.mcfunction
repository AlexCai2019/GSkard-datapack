...
execute as @s[team=red] as @e[team=blue,distance=..5] run damage @s 2 custom_buff:fire by @p[tag=yanyangdajian_fenshaozhiyu_damage]
execute as @a[team=blue] as @e[team=red,distance=..5] run damage @s 2 custom_buff:fire by @p[tag=yanyangdajian_fenshaozhiyu_damage]
