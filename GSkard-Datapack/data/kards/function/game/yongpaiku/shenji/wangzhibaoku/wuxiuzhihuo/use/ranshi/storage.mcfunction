...
execute as @s[scores={wuxiuzhihuo_slot=0}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=1}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=2}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=3}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=4}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=5}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=6}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=7}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=8}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=9}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=10}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=11}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=12}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=13}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=14}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=15}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=16}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=17}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=18}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=19}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=20}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=21}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=22}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=23}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=24}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=25}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=26}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=27}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=28}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=29}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=30}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=31}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=32}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=33}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=34}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
...
execute as @s[scores={wuxiuzhihuo_slot=35}] store result block 0 -60 -48 Items[0].components."minecraft:custom_data".ranshi int 1 run scoreboard players get @s wuxiuzhihuo_ranshi
