...
execute if score @s Rotation_1 matches 1..90 if data entity @s {OnGround:1b} rotated ~ 0 at @s positioned ^ ^ ^0.25 unless block ~0.25 ~0.25 ~0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute if score @s Rotation_1 matches 1..90 if data entity @s {OnGround:1b} rotated ~ 0 at @s positioned ^ ^ ^0.25 unless block ~0.25 ~0.25 ~-0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute if score @s Rotation_1 matches 1..90 if data entity @s {OnGround:1b} rotated ~ 0 at @s positioned ^ ^ ^0.25 unless block ~-0.25 ~0.25 ~0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute if score @s Rotation_1 matches 1..90 if data entity @s {OnGround:1b} rotated ~ 0 at @s positioned ^ ^ ^0.25 unless block ~-0.25 ~0.25 ~-0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0

execute if score @s Rotation_1 matches 1..90 unless data entity @s {OnGround:1b} rotated ~ 0 at @s positioned ^ ^ ^0.25 unless block ~0.25 ~0.25 ~0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute if score @s Rotation_1 matches 1..90 unless data entity @s {OnGround:1b} rotated ~ 0 at @s positioned ^ ^ ^0.25 unless block ~0.25 ~0.25 ~-0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute if score @s Rotation_1 matches 1..90 unless data entity @s {OnGround:1b} rotated ~ 0 at @s positioned ^ ^ ^0.25 unless block ~-0.25 ~0.25 ~0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute if score @s Rotation_1 matches 1..90 unless data entity @s {OnGround:1b} rotated ~ 0 at @s positioned ^ ^ ^0.25 unless block ~-0.25 ~0.25 ~-0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0

execute unless score @s Rotation_1 matches 1..90 at @s positioned ^ ^ ^0.25 unless block ~0.25 ~0.25 ~0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute unless score @s Rotation_1 matches 1..90 at @s positioned ^ ^ ^0.25 unless block ~0.25 ~0.25 ~-0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute unless score @s Rotation_1 matches 1..90 at @s positioned ^ ^ ^0.25 unless block ~-0.25 ~0.25 ~0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
execute unless score @s Rotation_1 matches 1..90 at @s positioned ^ ^ ^0.25 unless block ~-0.25 ~0.25 ~-0.25 #kards:no_collision_blocks run return run scoreboard players set @s diaolingtaidao_tujing 0
