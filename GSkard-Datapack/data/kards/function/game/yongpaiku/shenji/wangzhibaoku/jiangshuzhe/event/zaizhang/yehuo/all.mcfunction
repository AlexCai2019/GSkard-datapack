...
execute as @e[team=red,tag=JiangShuZhe_YeHuo] at @s positioned ~ ~-1 ~ as @e[tag=!spectator,team=blue,distance=..1.5] run damage @s 0.5 custom_buff:fire by @n[tag=JiangShuZhe_YeHuo,team=red]
execute as @e[team=blue,tag=JiangShuZhe_YeHuo] at @s positioned ~ ~-1 ~ as @e[tag=!spectator,team=red,distance=..1.5] run damage @s 0.5 custom_buff:fire by @n[tag=JiangShuZhe_YeHuo,team=blue]
