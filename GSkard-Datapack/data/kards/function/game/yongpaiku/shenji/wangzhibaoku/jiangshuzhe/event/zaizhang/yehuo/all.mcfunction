...
execute as @e[team=red,tag=JiangShuZhe_YeHuo] at @s run scoreboard players add @a[gamemode=adventure,team=blue,distance=..1.5] RanShao 2
execute as @e[team=blue,tag=JiangShuZhe_YeHuo] at @s run scoreboard players add @a[gamemode=adventure,team=red,distance=..1.5] RanShao 2
