...
execute if score @s random matches 7 run function kards:game/yongpaiku/shenji/wangzhibaoku/xiangzhaoyushi/give
...
execute if score @s random matches 11 run function kards:game/yongpaiku/shenji/wangzhibaoku/feishenghufu/give
...
execute if score @s random matches 14 run function kards:game/yongpaiku/shenji/wangzhibaoku/wuxiuzhihuo/give
