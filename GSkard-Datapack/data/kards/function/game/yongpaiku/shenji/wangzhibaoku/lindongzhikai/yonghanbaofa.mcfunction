...
execute if entity @s[team=red] run scoreboard players add @a[team=blue,tag=lindongzhikai] HealBack 2
execute if entity @s[team=blue] run scoreboard players add @a[team=red,tag=lindongzhikai] HealBack 2
