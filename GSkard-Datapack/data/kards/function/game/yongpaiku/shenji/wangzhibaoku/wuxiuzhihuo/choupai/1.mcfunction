...
execute unless score @s wuxiuzhihuo_random matches 1..388 run return fail

execute store result score @s wuxiuzhihuo_random run random value 1..110
execute if score @s wuxiuzhihuo_random matches 1..25 run function kards:game/yongpaiku/shenji/wangzhibaoku/wuxiuzhihuo/choupai/card/jiben
