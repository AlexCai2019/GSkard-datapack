...
execute as @e[tag=!Attribute_Use,type=#kards:mob,tag=!tuteng] run function kards:game/yongpaiku/use_general/attribute/_ with storage kards temp
schedule function kards:game/yongpaiku/use_general/attribute/ 2.5s