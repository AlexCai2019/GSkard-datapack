...
execute as @e[tag=Mob_Start] run function kards:game/yongpaiku/use_general/attribute/_ with storage kards temp
...
execute if score 回合数 GameRound matches 20.. run tellraw @a [{color:"#6796E6",text:"-"},{color:"#CCCCCC",text:" 护甲韧性倍率:("},{color:"gray",text:"+0.01"},{color:"#CCCCCC",text:"): "},{score:{name:"#system",objective:"temp_2"},color:"gray"},{text:".",color:"gray"},{score:{name:"#system",objective:"temp_3"},color:"gray"}]
