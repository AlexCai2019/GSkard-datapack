...
execute if entity @s[team=red] run scoreboard players set 红队 xianjing_laizishenchu 0

execute if entity @s[team=blue] run scoreboard players add @a[team=red] HealBack 32
execute if entity @s[team=blue] run scoreboard players set 蓝队 xianjing_laizishenchu 0
