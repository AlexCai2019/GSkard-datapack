...
execute as @e[type=#kards:mob,tag=!random_creaking] run data modify entity @s NoAI set value 0b
execute as @e[type=#kards:mob,tag=!random_creaking] run data modify entity @s Invulnerable set value 0b

execute if entity @s[team=red] run scoreboard players set 红队 xianjing_qianjunyifa 0
execute if entity @s[team=blue] run scoreboard players set 蓝队 xianjing_qianjunyifa 0

execute as @a at @s run playsound kards:whatfall master @s ~ ~ ~ 100 1
