...
tellraw @s [{text:"[经验商店]",color:"green"},{text:"您消耗了",color:"gray"},{text:"40级经验",color:"gold"},{text:"购买了",color:"gray"},{text:"失重 ",color:"white"},{text:"I",color:"gray"}]
function extra_enchantment:shelf/shizhong
