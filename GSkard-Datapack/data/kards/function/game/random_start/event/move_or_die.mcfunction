...
execute if score #system random_start matches 10 unless score #system GameStatus matches 0 run schedule function kards:game/random_start/event/move_or_die 1s append
