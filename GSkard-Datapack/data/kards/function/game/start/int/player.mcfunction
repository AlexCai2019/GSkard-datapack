...
item replace entity @a[tag=Ready] container.6 with minecraft:white_dye[item_name={text:"表情包",color:"green"},consumable={consume_seconds:0,animation:"bundle",has_consume_particles:false,sound:"ui.button.click"},custom_data={kards:'gif'},use_cooldown={seconds:5}]
