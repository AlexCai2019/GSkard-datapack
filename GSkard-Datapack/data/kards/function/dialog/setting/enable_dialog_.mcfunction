...
execute store result storage kards:setting infinite_round int 1 run scoreboard players get #system infinite_round 
execute store result storage kards:setting enter_pvp int 1 run scoreboard players get #system enter_pvp
