...
execute if score @s enchantment_chance_temp matches 1..30 on attacker if items entity @s weapon.mainhand *[enchantments~[{enchantments:'kards:diaoling',levels:1}]] run effect give @e[tag=enchantment_diaoling] wither 3 0 false
execute if score @s enchantment_chance_temp matches 1..40 on attacker if items entity @s weapon.mainhand *[enchantments~[{enchantments:'kards:diaoling',levels:2}]] run effect give @e[tag=enchantment_diaoling] wither 4 0 false
execute if score @s enchantment_chance_temp matches 1..50 on attacker if items entity @s weapon.mainhand *[enchantments~[{enchantments:'kards:diaoling',levels:3}]] run effect give @e[tag=enchantment_diaoling] wither 5 1 false
