advancement revoke @s only kards:shenqi/feishenghufu/sishenzhilian/eat/2

execute store result storage temp soul double 0.0001 run scoreboard players add @s feishenghufu_sishenzhilian_soul 250
