data modify entity @s Owner set from entity @n[tag=trident_juechang,type=trident] Owner
data modify entity @s item set from entity @n[tag=trident_juechang,type=trident] item
