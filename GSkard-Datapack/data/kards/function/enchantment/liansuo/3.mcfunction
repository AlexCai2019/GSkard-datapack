function kards:enchantment/liansuo/1 with storage temp enchantment_temp
scoreboard players remove @n[tag=enchantment_liansuo_temp] enchantment_liansuo 1
...
execute if score @n[tag=enchantment_liansuo_temp] enchantment_liansuo matches 1.. as @n[tag=enchantment_liansuo_target,tag=!enchantment_liansuo_target_end] at @s run function kards:enchantment/liansuo/3
execute if score @n[tag=enchantment_liansuo_temp] enchantment_liansuo matches 1.. unless entity @n[tag=enchantment_liansuo_target,tag=!enchantment_liansuo_target_end] at @s run function kards:enchantment/liansuo/4
