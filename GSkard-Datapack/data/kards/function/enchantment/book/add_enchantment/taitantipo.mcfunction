item modify entity @s armor.chest {function:"set_enchantments",enchantments:{"kards:taitantipo":1},add:true}
execute store result score @s mainhand_enchantment_levels run data get entity @s equipment.chest.components."minecraft:enchantments".kards:taitantipo
