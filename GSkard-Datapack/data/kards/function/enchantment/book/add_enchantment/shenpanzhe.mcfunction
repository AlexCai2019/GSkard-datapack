item modify entity @s armor.head {function:"set_enchantments",enchantments:{"kards:shenpanzhe":1},add:true}
execute store result score @s mainhand_enchantment_levels run data get entity @s equipment.head.components."minecraft:enchantments".kards:shenpanzhe
