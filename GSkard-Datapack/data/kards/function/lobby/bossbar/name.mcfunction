...
execute if score #system Ready_Num matches 0..1 run clone 107 227 -30 107 235 -22 105 227 -30
execute if score #system Ready_Num matches 2.. if entity @a[tag=Ready,team=lobby] run clone 107 227 -30 107 235 -22 105 227 -30
execute if score #system Ready_Num matches 2.. unless entity @a[tag=Ready,team=lobby] run clone 107 227 -20 107 235 -12 105 227 -30