...
tellraw @a [{selector:"@s"},{text: " 准备就绪 ",color:"green"},{text: "[",color:"gray"},{score:{name:"#system",objective:"Ready_Num"},color:"green"},{text: "/",color:"gray"},{score:{name:"#system",objective:"Number"},color:"gold"},{text: "]",color:"gray"}]
