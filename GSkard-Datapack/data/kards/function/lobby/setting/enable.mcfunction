...
#execute store result score #system random_gamerule run data get storage kards:setting random_gamerule
#execute store result score #system enter_pvp run data get storage kards:setting enter_pvp
#execute store result score #system infinite_round run data get storage kards:setting infinite_round
...
execute store result score #system worldborder run data get storage kards:setting pvp_worldborder_countdown
execute store result bossbar worldborder max run data get storage kards:setting pvp_worldborder_countdown

execute store result score #system worldborder run data get storage kards:setting pvp_start_countdown
execute store result bossbar pvp_start_countdown max run data get storage kards:setting pvp_start_countdown
