...
tellraw @a [{text:"每使用1张牌 都有概率额外获得",color:"gray",bold:true},{text:"[春暖花开]",color:"light_purple",bold:true},{text:"[好高骛远]",color:"white",bold:true},{text:"6K",color:"gold",bold:true}]
tellraw @a [{"text":"\n======——-——======\n","color":"gray"}]
