...
execute as @s[scores={PoJia=0}] run return run function custom_buff:pojia/bossbar/remove with storage custom_buff:temp
execute as @s[type=player] run function custom_buff:pojia/bossbar/2 with storage custom_buff:temp
