...
$bossbar add custom_buff:xuanyun_$(UUID) [{text:"眩晕",color:"dark_gray",bold:true}]
$bossbar set custom_buff:xuanyun_$(UUID) name [{text:"眩晕",color:"dark_gray",bold:true},{text:" | ",color:"#6796E6",bold:false},{text:"时间剩余:",color:gray,bold:false},{score:{name:"temp",objective:temp_2},color:green,bold:false},{text:".",color:green,bold:false},{score:{name:"temp",objective:temp_3},color:green,bold:false},{text:"秒",color:gray,bold:false},{text:" | ",color:"#6796E6",bold:false},{text:"视野受限 无法移动",color:red,bold:false}]
$bossbar set custom_buff:xuanyun_$(UUID) color red
$bossbar set custom_buff:xuanyun_$(UUID) players @s
$bossbar set custom_buff:xuanyun_$(UUID) visible true

$execute as @s[tag=!bossbar_max_XuanYun] store result bossbar custom_buff:xuanyun_$(UUID) max run scoreboard players get @s XuanYun
...
$execute store result bossbar custom_buff:xuanyun_$(UUID) value run scoreboard players get @s XuanYun
# 判断当前值是否比上一刻大
