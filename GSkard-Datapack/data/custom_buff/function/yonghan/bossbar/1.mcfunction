...
execute as @s[scores={YongHan=0}] run return run function custom_buff:yonghan/bossbar/remove with storage custom_buff:temp
execute as @s[type=player] run function custom_buff:yonghan/bossbar/2 with storage custom_buff:temp
...
execute as @s[scores={YongHan=180..}] at @s run function custom_buff:yonghan/2 with storage custom_buff:temp