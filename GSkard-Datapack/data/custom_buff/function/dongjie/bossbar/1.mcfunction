...
execute as @s[scores={DongJie=0}] run return run function custom_buff:dongjie/bossbar/remove with storage custom_buff:temp
execute as @s[type=player] run function custom_buff:dongjie/bossbar/2 with storage custom_buff:temp
...
function custom_buff:dongjie/tp with storage custom_buff:temp
