...
$bossbar add custom_buff:xuanzhuan_$(UUID) [{text:"旋转",color:"yellow",bold:true}]
$bossbar set custom_buff:xuanzhuan_$(UUID) name [{text:"旋转",color:"yellow",bold:true},{text:" | ",color:"#6796E6",bold:false},{text:"时间剩余:",color:gray,bold:false},{score:{name:"temp",objective:temp_2},color:green,bold:false},{text:".",color:green,bold:false},{score:{name:"temp",objective:temp_3},color:green,bold:false},{text:"秒",color:gray,bold:false},{text:" | ",color:"#6796E6",bold:false},{text:"每刻向顺时针转动27.5°",color:red,bold:false}]
$bossbar set custom_buff:xuanzhuan_$(UUID) color yellow
$bossbar set custom_buff:xuanzhuan_$(UUID) players @s
$bossbar set custom_buff:xuanzhuan_$(UUID) visible true

$execute as @s[tag=!bossbar_max_XuanZhuan] store result bossbar custom_buff:xuanzhuan_$(UUID) max run scoreboard players get @s XuanZhuan
...
$execute store result bossbar custom_buff:xuanzhuan_$(UUID) value run scoreboard players get @s XuanZhuan
# 判断当前值是否比上一刻大
